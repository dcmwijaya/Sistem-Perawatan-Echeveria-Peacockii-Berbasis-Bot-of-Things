...
#define WIFI_SSID "ISI NAMA ROUTER ANDA"
#define WIFI_PASSWORD "ISI PASSWORD ROUTER ANDA"
...
void sendData() { //Baca data sensor dan mengirim ke Blynk
  ...
  soilmeasurement = map(analogFC28,0,4095,0,100);
  kelembapan_tanah = soilmeasurement;

...
| Layar | LCD I2C (x1) |
| Komponen Lainnya | Kabel Mikro USB - USB tipe A (x1), Kabel jumper (1 set), ESP32 Expansion Board (x1), Breadboard (x1), Electrical relay 2 channel (x1), Adaptor DC 5V (x1), Resistor, Kotak casing (x1), Baut plus (1 set), dan Mur (1 set) |
